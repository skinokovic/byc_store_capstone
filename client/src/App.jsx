...
import MaintenancePage from "./components/MaintenancePage"; // 👈 NEW

function App() {
  const location = useLocation();
  const isAdminRoute = location.pathname.startsWith("/admin");

  // 👇 NEW: keeps /admin working normally, blocks everything else
  if (import.meta.env.VITE_MAINTENANCE === "true" && !isAdminRoute) {
